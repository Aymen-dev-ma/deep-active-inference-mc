...
class Game:
    def __init__(self, number_of_games=1):
        ...
        dataset = np.load(r'C:\Users\aymen\OneDrive\Documents\GitHub\deep-active-inference-mc\dsprites_ndarray_co1sh3sc6or40x32y32_64x64.npz', allow_pickle=True, encoding='latin1')
